...
import com.antherlisten.online.constants.ContentCountryKey
import com.antherlisten.online.constants.ContentLanguageKey
import com.antherlisten.online.constants.CountryCodeToName
import com.antherlisten.online.constants.EnableBetterLyricsKey
import com.antherlisten.online.constants.EnableKugouKey
import com.antherlisten.online.constants.EnableLrcLibKey
import com.antherlisten.online.constants.EnablePaxsenixKey
import com.antherlisten.online.constants.EnableLyricsPlus
import com.antherlisten.online.constants.HideExplicitKey
import com.antherlisten.online.constants.HideVideoSongsKey
import com.antherlisten.online.constants.HideYoutubeShortsKey
import com.antherlisten.online.constants.LanguageCodeToName
import com.antherlisten.online.constants.LyricsProviderOrderKey
import com.antherlisten.online.constants.ProxyEnabledKey
import com.antherlisten.online.constants.ProxyPasswordKey
import com.antherlisten.online.constants.ProxyTypeKey
import com.antherlisten.online.constants.ProxyUrlKey
import com.antherlisten.online.constants.ProxyUsernameKey
import com.antherlisten.online.constants.QuickPicks
import com.antherlisten.online.constants.QuickPicksKey
import com.antherlisten.online.constants.RandomizeHomeOrderKey
import com.antherlisten.online.constants.SYSTEM_DEFAULT
import com.antherlisten.online.constants.ShowArtistDescriptionKey
import com.antherlisten.online.constants.ShowMostStatsPlaylistsKey
import com.antherlisten.online.constants.ShowArtistSubscriberCountKey
import com.antherlisten.online.constants.ShowMonthlyListenersKey
import com.antherlisten.online.constants.ShowWrappedCardKey
import com.antherlisten.online.constants.TopSize
...
import com.antherlisten.online.ui.component.DraggableLyricsProviderItem
import com.antherlisten.online.ui.component.DraggableLyricsProviderList
    ...
    LaunchedEffect(showMostStatsPlaylists) {
        if (!showMostStatsPlaylists) {
            database.withTransaction {
                clearPlaylist(com.antherlisten.online.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID)
                clearPlaylist(com.antherlisten.online.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID)
                delete(
                    com.antherlisten.online.db.entities.PlaylistEntity(
                        id = com.antherlisten.online.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
                delete(
                    com.antherlisten.online.db.entities.PlaylistEntity(
                        id = com.antherlisten.online.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
            }
