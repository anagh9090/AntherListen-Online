            ...
            remember {
                songSelection
                    .map { song ->
                        ...
                        val metadata = song.toMediaMetadata()
                        com.antherlisten.online.db.entities.Song(
                            song =
                                com.antherlisten.online.db.entities.SongEntity(
                                    id = metadata.id,
                            ...
                            artists =
                                metadata.artists.map { artist ->
                                    com.antherlisten.online.db.entities.ArtistEntity(
                                        id = artist.id ?: "",
                                        name = artist.name,
                                    )
                                },
                            album =
                                metadata.album?.let { album ->
                                    com.antherlisten.online.db.entities.AlbumEntity(
                                        id = album.id,
                                        title = album.title,
