...
package com.antherlisten.online.listentogether
...
import com.antherlisten.online.constants.ListenTogetherAutoApprovalKey
import com.antherlisten.online.constants.ListenTogetherAutoApproveSuggestionsKey
import com.antherlisten.online.constants.ListenTogetherIsHostKey
import com.antherlisten.online.constants.ListenTogetherRoomCodeKey
import com.antherlisten.online.constants.ListenTogetherServerUrlKey
import com.antherlisten.online.constants.ListenTogetherSessionTimestampKey
import com.antherlisten.online.constants.ListenTogetherSessionTokenKey
import com.antherlisten.online.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient
    ...
    constructor(
        ...
        companion object {
            ...
            const val ACTION_APPROVE_JOIN = "com.antherlisten.online.LISTEN_TOGETHER_APPROVE_JOIN"
            const val ACTION_REJECT_JOIN = "com.antherlisten.online.LISTEN_TOGETHER_REJECT_JOIN"
            const val ACTION_APPROVE_SUGGESTION = "com.antherlisten.online.LISTEN_TOGETHER_APPROVE_SUGGESTION"
            const val ACTION_REJECT_SUGGESTION = "com.antherlisten.online.LISTEN_TOGETHER_REJECT_SUGGESTION"
        ...
        private fun loadBlockedUsernames() {
            try {
                val blockedJson = context.dataStore.get(com.antherlisten.online.constants.ListenTogetherBlockedUsersKey, "")
                val blockedList =
        ...
        private suspend fun saveBlockedUsernames() {
            try {
                ...
                context.safeDataStoreEdit { preferences ->
                    preferences[com.antherlisten.online.constants.ListenTogetherBlockedUsersKey] = blockedJson
                }
            } catch (e: Exception) {
