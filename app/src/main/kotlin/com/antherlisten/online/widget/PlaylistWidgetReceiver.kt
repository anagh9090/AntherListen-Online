...
class PlaylistWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        ...
        const val ACTION_PLAY_TARGET = "com.antherlisten.online.widget.playlists.PLAY_TARGET"
        const val ACTION_UPDATE_WIDGET = "com.antherlisten.online.widget.playlists.UPDATE_WIDGET"
