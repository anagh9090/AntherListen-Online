...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.antherlisten.online.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "com.antherlisten.online.widget.LIKE"
        const val ACTION_NEXT = "com.antherlisten.online.widget.NEXT"
        const val ACTION_PREVIOUS = "com.antherlisten.online.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "com.antherlisten.online.widget.UPDATE_WIDGET"
    }
}
